...
class PPPPCopy extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            step: 1,
    ...
    handleStep1Next () {
        var required = ['product', 'description', 'proof', 'cta'];
                ...
                <div step='1' handleNext={this.handleStep1Next} title={this.props.pageName}>
                    <FormController updateValues={this.updateValues} errorIds={this.state.errorIds} currentValues={this.state.values}>
                        ...
                        <div
                            ...
                            inputId='proof'
                            title='Social Proof'
                            description="Social proof is required for the 4 P's style ad copy. You can enter a short review, or a general statement."
                            type='textarea'
                            rows='2'
                            maxlength='200'
                            placeholder='e.g. Scribeo is trusted by over 1000 businesses.'
                        />
                        <div
                            required={true}
                            inputId='cta'
